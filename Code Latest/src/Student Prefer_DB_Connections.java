...
public class StudentPreferencesForm_GUI extends JFrame {
    ...
    private void registerUser(String firstName, String lastName, String userName, String email, String hashedPassword, String userType) {
        ...
        // Implementation for user registration logic with `conn`
        // You would include SQL insert statements here, using PreparedStatement to insert the data.
        // E.g., String sql = "INSERT INTO users (first_name, last_name, user_name, email, password, user_type) VALUES (?, ?, ?, ?, ?, ?)";
        // Follow up with execution and handling logic here.
        
        System.out.println("User registered successfully with provided details.");
    }
    ...
    private class SubmitButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            registerUser("John", "Doe", "johndoe", "johndoe@example.com", "hashedpassword123", "Student");
        }
    }
